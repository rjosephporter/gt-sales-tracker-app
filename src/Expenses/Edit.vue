    ...
    data () {
      return {
      	...
      	expense: {
      		...
      		name: 'Electricity',
      		amount: 29500.25,
      		remarks: 'Slightly bigger due to high margin in sales'
      	}
      }
    },
    methods: {
      ...
      reset () {
        this.expense.date = this.moment().format('YYYY-MM-DD');
        this.expense.name = 'Electricity';
        this.expense.amount = 29500.25;
        this.expense.remarks = 'Slightly bigger due to high margin in sales';
